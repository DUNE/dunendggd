...
class CryostatLegsAndConnectorsandInletsBuilder(gegede.builder.Builder):

    #^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^~^
    def configure( self, dz=None,
    ...
    def construct( self, geom ):
        ...
        inlet_lv   = sbs[2].get_volume()
        conn_lv    = sbs[3].get_volume()
        leg_lv     = sbs[0].get_volume()
        legcon_lv = sbs[1].get_volume()
