...
class SandECalEndcapBuilder(gegede.builder.Builder):
    ...
    def construct(self, geom):
        ...
        for mod in range(0,16):
            ...
            ECAL_ec_mod_curv_shape = geom.shapes.Tubs('ECAL_ec_mod_curv_'+str(mod)+'_shape1',
            ...
            ECAL_ec_mod_hor_shape = geom.shapes.Box('ECAL_ec_mod_hor_'+str(mod)+'_shape1',
                                        dx=KLOECellWidth*ColPerMod/2.,
            ...
            ECAL_ec_mod_curv_top_rot1 = geom.structure.Rotation('ECAL_ec_mod_curv_'+str(mod)+'_top_rot1',
                                                Q('0deg'),Q('-90deg'),Q('0deg'))
            
            ECAL_ec_mod_curv_bot_pos1 = geom.structure.Position(
                    'ECAL_ec_mod_curv_'+str(mod)+'_bot_pos1',
                    XPosMod - XPosMod, Curv_y_bottom - YPosMod, Curv_z_pos - (ZPosMod + 0.5*AlPlateThick))

            ECAL_ec_mod_curv_bot_rot1 = geom.structure.Rotation('ECAL_ec_mod_curv_'+str(mod)+'_bot_rot1',
                                                Q('0deg'),Q('-90deg'),Q('180deg'))
            
            ECAL_ec_mod_hor_top_pos1 = geom.structure.Position('ECAL_ec_mod_hor_'+str(mod)+'_top_pos1',
                                                    XPosMod - XPosMod,
						                            Straight_y_pos - YPosMod,
                                                    Straight_z_pos - (ZPosMod + 0.5*AlPlateThick))

            ECAL_ec_mod_hor_top_rot1 = geom.structure.Rotation('ECAL_ec_mod_hor_'+str(mod)+'_top_rot1',
                                                Q('90deg'),Q('0deg'),Q('0deg'))
            
            ECAL_ec_mod_hor_bot_pos1 = geom.structure.Position('ECAL_ec_mod_hor_'+str(mod)+'_bot_pos1',
                                                XPosMod  - XPosMod,
                                                -Straight_y_pos - YPosMod,
                                                Straight_z_pos - (ZPosMod + 0.5*AlPlateThick))
            ...
            ECAL_ec_mod_step2 = geom.shapes.Boolean("ECAL_ec_mod_"+str(mod)+"_step2",
                                                type='union',
            ...
            ECAL_ec_mod_shape = geom.shapes.Boolean("ECAL_ec_mod_"+str(mod)+"_shape",
                                                type='union',
            ...
            if(mod > 1):
                ECAL_ec_mod_shape = geom.shapes.Boolean("ECAL_ec_central_mod_"+str(mod)+"_shape",
                                                    type='union',
