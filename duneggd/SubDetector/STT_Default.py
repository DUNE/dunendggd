...
class STTBuilder(gegede.builder.Builder):
    ...
    def construct(self, geom):
        ...
        #print("Test : "+str(self.STT_startX) + " "+str(self.STT_startX) + " "+str(self.kloeVesselRadius) + " "+str(self.GRAINThickness) + " "+str(self.clearenceECALGRAIN))
        #print("Test 2 : "+str(self.clearenceECALGRAIN - self.GRAINThickness))
        ...
        for mod_id in range(len(self.module_sequence)):
            ...
            #print ("**** Done building STT MODULE "+str(mod_id)+" "+self.module_sequence[mod_id])
